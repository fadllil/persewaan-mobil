...
class DaftarMobilDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row){
                $btn = '<a href="/daftar-mobil/sewa/'.$row->id.'" class="btn btn-primary">Sewa</a>';
                return $btn;
            })
            ->setRowId('id');
    }
    ...
    {
        return $model->where('status', 'Tersedia')->newQuery();
    }
    ...
    {
        return 'DaftarMobil_' . date('YmdHis');
    }
}
