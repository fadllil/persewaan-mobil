...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Ubah Data Mobil') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('master-mobil.update', $data->id) }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="year" class="form-control @error('tahun') is-invalid @enderror" name="tahun" value="{{ $data->tahun }}" required autocomplete="tahun" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="no_plat" type="text" class="form-control @error('no_plat') is-invalid @enderror" name="no_plat" value="{{ $data->no_plat }}" required autocomplete="no_plat" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tarif" type="text" class="form-control @error('tarif') is-invalid @enderror" name="tarif" value="Rp. {{ number_format($data->tarif, 0, ',', '.') }}" required autocomplete="tarif" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select select2" id="status" name="status" aria-label="Default select example" required>
                                    ...
                                    <option @if($data->status == 'Tersedia') selected @endif value="Tersedia">Tersedia</option>
                                    <option @if($data->status == 'Disewa') selected @endif value="Disewa">Disewa</option>
                                    <option @if($data->status == 'Tidak Tersedia') selected @endif value="Tidak Tersedia">Tidak Tersedia</option>
                                </select>
